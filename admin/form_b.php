...
{    
    ...
    mysqli_query($con,"insert into berita values('','".date('Y-m-d')."','$judul','$konten','".($getId[0]+1).$ext."')");
      echo "
    <script>
...
elseif(isset($_POST['update']))
{
    ...
    { 
        ...
        mysqli_query($con,"update berita set judul='$judul',konten='$konten', gambar='".$_GET['id'].$ext."' where id='".$_GET['id']."'");
    }
    else
                   ...
                   <input type="hidden" name="gambar" value="<?php echo isset($data[2])?$data[2]:''; ?>">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Judul" name="judul" id="tiga" value="<?php echo isset($data[2])?$data[2]:''; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tiga" class="col-sm-2 control-label">Isi Berita</label>
                            <div class="col-sm-10">
                                <textarea class="form-control konten" placeholder="Isi Berita" name="konten"><?php echo isset($data[3])?$data[3]:''; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div id="image-holder">
                                   <?php
                                    if(isset($_GET['id']))
                                        echo "<img src='../img/$data[4].'?rand='".rand()."' alt=''>";
                                    ?>
                                </div>
                                <script>
